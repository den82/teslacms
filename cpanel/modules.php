        ...
        <div class="row content">
            ...
            <div class="col-xl-10 col-md-9 col-sm-12 content_right">
                ...
                if ($_GET['result'] == 'success_install') {
                  echo "<div class='alert alert-success'>".$lang[$code]['module installed successfully']."</div>";
                }
                else if ($_GET['result'] == 'fail_install') {
                  echo "<div class='alert alert-danger'>".$lang[$code]['module not installed']."</div>";
                }
                if ($_GET['result'] == 'success_uninstall') {
                  echo "<div class='alert alert-success'>".$lang[$code]['module uninstalled successfully']."</div>";
                }
                else if ($_GET['result'] == 'fail_uninstall') {
                  echo "<div class='alert alert-danger'>".$lang[$code]['module not uninstalled']."</div>";
                }
                else {
                  echo "";
                }
