        ...
        <div class="row content">
            ...
            <div class="col-xl-10 col-md-9 col-sm-12 content_right">
                ...
                <div class="breadcrumbs">
                  <?php 
                  $module_name = get_module_name_by_dir($conn, $_GET['module']);
                  display_breadcrumbs($conn, $_SERVER['REQUEST_URI'], $module_name, $lang[$code]); ?>
                </div>
                ...
                if ($_GET['mode'] == 'settings') {
                  //$module_dir = get_module_dir($conn, $_GET['module']);
                  include_once("../content/modules/".$_GET['module']."/settings.php");
                }
