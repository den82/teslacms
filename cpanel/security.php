...
include('include/functions/f_security.php');
     ...
     <div class="container-fluid">
        ...
        <div class="row content">
            ...
            <div class="col-xl-10 col-md-9 col-sm-12 content_right">
                ...
                if ($_GET['mode'] == 'edit') {
                  if ($_GET['type'] == 'white_ip_list') {
                    $white_ip_list = get_white_ip_list($conn);
                    display_white_ip_list($white_ip_list, $lang[$code]);
                  }
                }
                else if ($_GET['mode'] == 'show') {
                  if ($_GET['type'] == 'logs') {
                 	  $logs = get_logs($conn, '50');
                    display_logs($logs, $lang[$code]);
                  }
                }
                else {
                  display_security($lang[$code]);
                }
                ?>
            </div>
